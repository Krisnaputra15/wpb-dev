...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Daftar Kontak Perusahaan</h4>
                </div>
                {{-- <div class="col-lg-6">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row-reverse mb-4">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#add-modal">Tambah Kontak Perusahaan</button>
                        </div>
                        <div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="standard-modalLabel">Tambah Kontak Perusahaan</h4>
                                    ...
                                    <div class="modal-body">
                                        <form class="px-3" id="add-form">
                                            ...
                                            <div class="mb-3 mt-3">
                                                <label for="phone_number" class="form-label">Nomor Telepon / WA <small class="text-danger">*</small></label>
                                                <input class="form-control" type="text" id="phone_number" name="phone_number"
                                                    required
                                                    placeholder="Nomor Telepon / WA Perusahaan">
                                                <small class="text-danger error" id="phone_numberError"></small>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#alternative-page-datatable').DataTable({
                ...
                language: {
                    emptyTable: "Tidak ada data kontak perusahaan tersimpan" // Text to display when no data is present
                }
            });
            ...
            $('#add-form').on('submit', function(e) {
                ...
                // Send AJAX request
                $.ajax({
                    url: "{{ route('companyContact.store') }}",
                    type: "POST",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
        ...
        function showDeleteConfirmation(userId){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{route('companyContact.destroy', ':id')}}".replace(':id', userId),
                        type: "DELETE",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
