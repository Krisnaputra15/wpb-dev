...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Daftar Akun</h4>
                </div>
                {{-- <div class="col-lg-6">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row-reverse mb-4">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#generate-modal">Generate Akun</button>
                        </div>
                        <div id="generate-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="standard-modalLabel">Generate Akun</h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="px-3" id="generate-form">
                                            <small>* password default untuk setiap akun adalah 'password' (tanpa tanda petik)</small>
                                            <div class="mb-3 mt-3">
                                                <label for="username" class="form-label">Jumlah <small class="text-danger">*</small></label>
                                                <input class="form-control" type="number" id="quantity" name="quantity"
                                                    max="50" min="1"
                                                    placeholder="Jumlah maksimal 50 akun sekali buat">
                                                <small class="text-danger error" id="quantityError"></small>
                                            </div>

                                            <div class="mb-3">
                                                <label for="emailaddress" class="form-label">Role <small class="text-danger">*</small></label>
                                                <select class="form-select" name="role" id="role" data-select-type="select2" data-placeholder="Pilih role">
                                                    <option selected hidden disabled value="">Pilih Role</option>
                                                    <option value="administrator">Administrator</option>
                                                    <option value="humas">Humas</option>
                                                    <option value="perwakilan-perusahaan">Perwakilan Perusahaan</option>
                                                    <option value="random">Acak</option>
                                                </select>
                                                <small class="text-danger error" id="roleError"></small>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#alternative-page-datatable').DataTable({
                ...
                language: {
                    emptyTable: "Tidak ada data akun tersimpan"
                }
            });
            ...
            $('#generate-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(error) {
                        ...
                        submitButton.html('Generate'); // Restore button text on error
        ...
        function showDeleteConfirmation(userId){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{route('account.destroy', ':id')}}".replace(':id', userId),
                        type: "DELETE",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
